 ...
 * @author Seek
 */
public final class PosEchoTask extends PosTask {
	...
	public Arguments getDefaultParameters() {
		...
		arguments.addArgument(ECHO_DATA, "abcdefg");
		return arguments;
	}
	...
	protected byte[] buildBodyMessage(JavaSamplerContext context)
		...
		String echoData = context.getParameter(ECHO_DATA);
		map.put(ECHO_DATA, echoData);
		
		BuildMessage buildMessage = MessageFactory.getBuildMessage(BusinessType.PosEcho);
