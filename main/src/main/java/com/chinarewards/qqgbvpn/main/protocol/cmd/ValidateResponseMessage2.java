...
public class ValidateResponseMessage2 implements ICommand {
	...
	public String toString() {
		return " [cmdId=" + cmdId + ", resultName=" + resultName
				+ ", resultExplain=" + resultExplain + ", currentTime="
				+ currentTime + ", useTime=" + useTime + ", validTime="
				+ validTime + ", qqws_resultcode=" + qqws_resultcode
				+ ", qqvalidate_resultstatus=" + qqvalidate_resultstatus
				+ ", validate_count=" + validate_count + ", first_posId="
				+ first_posId + ", prev_posId=" + prev_posId
				+ ", first_validate_time=" + first_validate_time
				+ ", prev_validate_time=" + prev_validate_time + "]";
	}
